...
- Pattern: **the middle is a list of rows, and every row answers the cursor.** That is where the missing aliveness lives: not in animated prose, in interactive indexes.
